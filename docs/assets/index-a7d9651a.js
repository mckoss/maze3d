...
#endif`,Kp="gl_FragColor = linearToOutputTexel( gl_FragColor );",Yp=`vec4 LinearToLinear( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function _l(){return new Yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:bo(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function vl(){return new Yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:bo(),fragmentShader:`
	...
	`}function hg(c){let t=new WeakMap,e=null;function i(u){if(u&&u.isTexture){const p=u.mapping,d=p===ao||p===lo,f=p===Ei||p===Ti;if(d||f)if(u.isRenderTargetTexture&&u.needsPMREMUpdate===!0){u.needsPMREMUpdate=!1;let m=t.get(u);return e===null&&(e=new ml(c)),m=d?e.fromEquirectangular(u,m):e.fromCubemap(u,m),t.set(u,m),m.texture}else{if(t.has(u))return t.get(u).texture;{const m=u.image;if(d&&m&&m.height>0||f&&m&&o(m)){e===null&&(e=new ml(c));const _=d?e.fromEquirectangular(u):e.fromCubemap(u);return t.set(u,_),u.addEventListener("dispose",a),_.texture}else return null}}}return u}function o(u){let p=0;const d=6;for(let f=0;f<d;f++)u[f]!==void 0&&p++;return p===d}function a(u){const p=u.target;p.removeEventListener("dispose",a);const d=t.get(p);d!==void 0&&(t.delete(p),d.dispose())}function h(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:i,dispose:h}}function dg(c){const t={};function e(i){if(t[i]!==void 0)return t[i];let o;switch(i){case"WEBGL_depth_texture":o=c.getExtension("WEBGL_depth_texture")||c.getExtension("MOZ_WEBGL_depth_texture")||c.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":o=c.getExtension("EXT_texture_filter_anisotropic")||c.getExtension("MOZ_EXT_texture_filter_anisotropic")||c.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":o=c.getExtension("WEBGL_compressed_texture_s3tc")||c.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||c.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":o=c.getExtension("WEBGL_compressed_texture_pvrtc")||c.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:o=c.getExtension(i)}return t[i]=o,o}return{has:function(i){return e(i)!==null},init:function(i){i.isWebGL2?e("EXT_color_buffer_float"):(e("WEBGL_depth_texture"),e("OES_texture_float"),e("OES_texture_half_float"),e("OES_texture_half_float_linear"),e("OES_standard_derivatives"),e("OES_element_index_uint"),e("OES_vertex_array_object"),e("ANGLE_instanced_arrays")),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture")},get:function(i){const o=e(i);return o===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),o}}}function pg(c,t,e,i){const o={},a=new WeakMap;function h(m){const _=m.target;_.index!==null&&t.remove(_.index);for(const y in _.attributes)t.remove(_.attributes[y]);_.removeEventListener("dispose",h),delete o[_.id];const b=a.get(_);b&&(t.remove(b),a.delete(_)),i.releaseStatesOfGeometry(_),_.isInstancedBufferGeometry===!0&&delete _._maxInstanceCount,e.memory.geometries--}function u(m,_){return o[_.id]===!0||(_.addEventListener("dispose",h),o[_.id]=!0,e.memory.geometries++),_}function p(m){const _=m.attributes;for(const y in _)t.update(_[y],34962);const b=m.morphAttributes;for(const y in b){const x=b[y];for(let g=0,S=x.length;g<S;g++)t.update(x[g],34962)}}function d(m){const _=[],b=m.index,y=m.attributes.position;let x=0;if(b!==null){const L=b.array;x=b.version;for(let E=0,D=L.length;E<D;E+=3){const P=L[E+0],k=L[E+1],V=L[E+2];_.push(P,k,k,V,V,P)}}else{const L=y.array;x=y.version;for(let E=0,D=L.length/3-1;E<D;E+=3){const P=E+0,k=E+1,V=E+2;_.push(P,k,k,V,V,P)}}const g=new(Wl(_)?Jl:Zl)(_,1);g.version=x;const S=a.get(m);S&&t.remove(S),a.set(m,g)}function f(m){const _=a.get(m);if(_){const b=m.index;b!==null&&_.version<b.version&&d(m)}else d(m);return a.get(m)}return{get:u,update:p,getWireframeAttribute:f}}function fg(c,t,e,i){const o=i.isWebGL2;let a;function h(_){a=_}let u,p;function d(_){u=_.type,p=_.bytesPerElement}function f(_,b){c.drawElements(a,b,u,_*p),e.update(b,a,1)}function m(_,b,y){if(y===0)return;let x,g;if(o)x=c,g="drawElementsInstanced";else if(x=t.get("ANGLE_instanced_arrays"),g="drawElementsInstancedANGLE",x===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}x[g](a,b,u,_*p,y),e.update(b,a,y)}this.setMode=h,this.setIndex=d,this.render=f,this.renderInstances=m}function mg(c){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(a,h,u){switch(e.calls++,h){case 4:e.triangles+=u*(a/3);break;case 1:e.lines+=u*(a/2);break;case 3:e.lines+=u*(a-1);break;case 2:e.lines+=u*a;break;case 0:e.points+=u*a;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",h);break}}function o(){e.frame++,e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:o,update:i}}function gg(c,t){return c[0]-t[0]}function _g(c,t){return Math.abs(t[1])-Math.abs(c[1])}function vg(c,t,e){const i={},o=new Float32Array(8),a=new WeakMap,h=new ve,u=[];for(let d=0;d<8;d++)u[d]=[d,0];function p(d,f,m,_){const b=d.morphTargetInfluences;if(t.isWebGL2===!0){const x=f.morphAttributes.position||f.morphAttributes.normal||f.morphAttributes.color,g=x!==void 0?x.length:0;let S=a.get(f);if(S===void 0||S.count!==g){let nt=function(){U.dispose(),a.delete(f),f.removeEventListener("dispose",nt)};var y=nt;S!==void 0&&S.texture.dispose();const D=f.morphAttributes.position!==void 0,P=f.morphAttributes.normal!==void 0,k=f.morphAttributes.color!==void 0,V=f.morphAttributes.position||[],w=f.morphAttributes.normal||[],R=f.morphAttributes.color||[];let z=0;D===!0&&(z=1),P===!0&&(z=2),k===!0&&(z=3);let et=f.attributes.position.count*z,ut=1;et>t.maxTextureSize&&(ut=Math.ceil(et/t.maxTextureSize),et=t.maxTextureSize);const B=new Float32Array(et*ut*4*g),U=new $l(B,et,ut,g);U.type=Gn,U.needsUpdate=!0;const tt=z*4;for(let W=0;W<g;W++){const Q=V[W],lt=w[W],ot=R[W],H=et*ut*4*W;for(let $=0;$<Q.count;$++){const J=$*tt;D===!0&&(h.fromBufferAttribute(Q,$),B[H+J+0]=h.x,B[H+J+1]=h.y,B[H+J+2]=h.z,B[H+J+3]=0),P===!0&&(h.fromBufferAttribute(lt,$),B[H+J+4]=h.x,B[H+J+5]=h.y,B[H+J+6]=h.z,B[H+J+7]=0),k===!0&&(h.fromBufferAttribute(ot,$),B[H+J+8]=h.x,B[H+J+9]=h.y,B[H+J+10]=h.z,B[H+J+11]=ot.itemSize===4?h.w:1)}}S={count:g,texture:U,size:new Yt(et,ut)},a.set(f,S),f.addEventListener("dispose",nt)}let L=0;for(let D=0;D<b.length;D++)L+=b[D];const E=f.morphTargetsRelative?1:1-L;_.getUniforms().setValue(c,"morphTargetBaseInfluence",E),_.getUniforms().setValue(c,"morphTargetInfluences",b),_.getUniforms().setValue(c,"morphTargetsTexture",S.texture,e),_.getUniforms().setValue(c,"morphTargetsTextureSize",S.size)}else{const x=b===void 0?0:b.length;let g=i[f.id];if(g===void 0||g.length!==x){g=[];for(let P=0;P<x;P++)g[P]=[P,0];i[f.id]=g}for(let P=0;P<x;P++){const k=g[P];k[0]=P,k[1]=b[P]}g.sort(_g);for(let P=0;P<8;P++)P<x&&g[P][1]?(u[P][0]=g[P][0],u[P][1]=g[P][1]):(u[P][0]=Number.MAX_SAFE_INTEGER,u[P][1]=0);u.sort(gg);const S=f.morphAttributes.position,L=f.morphAttributes.normal;let E=0;for(let P=0;P<8;P++){const k=u[P],V=k[0],w=k[1];V!==Number.MAX_SAFE_INTEGER&&w?(S&&f.getAttribute("morphTarget"+P)!==S[V]&&f.setAttribute("morphTarget"+P,S[V]),L&&f.getAttribute("morphNormal"+P)!==L[V]&&f.setAttribute("morphNormal"+P,L[V]),o[P]=w,E+=w):(S&&f.hasAttribute("morphTarget"+P)===!0&&f.deleteAttribute("morphTarget"+P),L&&f.hasAttribute("morphNormal"+P)===!0&&f.deleteAttribute("morphNormal"+P),o[P]=0)}const D=f.morphTargetsRelative?1:1-E;_.getUniforms().setValue(c,"morphTargetBaseInfluence",D),_.getUniforms().setValue(c,"morphTargetInfluences",o)}}return{update:p}}function xg(c,t,e,i){let o=new WeakMap;function a(p){const d=i.render.frame,f=p.geometry,m=t.get(p,f);return o.get(m)!==d&&(t.update(m),o.set(m,d)),p.isInstancedMesh&&(p.hasEventListener("dispose",u)===!1&&p.addEventListener("dispose",u),e.update(p.instanceMatrix,34962),p.instanceColor!==null&&e.update(p.instanceColor,34962)),m}function h(){o=new WeakMap}function u(p){const d=p.target;d.removeEventListener("dispose",u),e.remove(d.instanceMatrix),d.instanceColor!==null&&e.remove(d.instanceColor)}return{update:a,dispose:h}}const rc=new Ve,sc=new $l,oc=new np,ac=new ec,xl=[],bl=[],wl=new Float32Array(16),yl=new Float32Array(9),Ml=new Float32Array(4);function Ri(c,t,e){const i=c[0];if(i<=0||i>0)return c;const o=t*e;let a=xl[o];if(a===void 0&&(a=new Float32Array(o),xl[o]=a),t!==0){i.toArray(a,0);for(let h=1,u=0;h!==t;++h)u+=e,c[h].toArray(a,u)}return a}function ce(c,t){if(c.length!==t.length)return!1;for(let e=0,i=c.length;e<i;e++)if(c[e]!==t[e])return!1;return!0}function ue(c,t){for(let e=0,i=t.length;e<i;e++)c[e]=t[e]}function Zr(c,t){let e=bl[t];e===void 0&&(e=new Int32Array(t),bl[t]=e);for(let i=0;i!==t;++i)e[i]=c.allocateTextureUnit();return e}function bg(c,t){const e=this.cache;e[0]!==t&&(c.uniform1f(this.addr,t),e[0]=t)}function wg(c,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(c.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ce(e,t))return;c.uniform2fv(this.addr,t),ue(e,t)}}function yg(c,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(c.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(c.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ce(e,t))return;c.uniform3fv(this.addr,t),ue(e,t)}}function Mg(c,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(c.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ce(e,t))return;c.uniform4fv(this.addr,t),ue(e,t)}}function Sg(c,t){const e=this.cache,i=t.elements;if(i===void 0){if(ce(e,t))return;c.uniformMatrix2fv(this.addr,!1,t),ue(e,t)}else{if(ce(e,i))return;Ml.set(i),c.uniformMatrix2fv(this.addr,!1,Ml),ue(e,i)}}function Cg(c,t){const e=this.cache,i=t.elements;if(i===void 0){if(ce(e,t))return;c.uniformMatrix3fv(this.addr,!1,t),ue(e,t)}else{if(ce(e,i))return;yl.set(i),c.uniformMatrix3fv(this.addr,!1,yl),ue(e,i)}}function Eg(c,t){const e=this.cache,i=t.elements;if(i===void 0){if(ce(e,t))return;c.uniformMatrix4fv(this.addr,!1,t),ue(e,t)}else{if(ce(e,i))return;wl.set(i),c.uniformMatrix4fv(this.addr,!1,wl),ue(e,i)}}function Tg(c,t){const e=this.cache;e[0]!==t&&(c.uniform1i(this.addr,t),e[0]=t)}function Pg(c,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(c.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ce(e,t))return;c.uniform2iv(this.addr,t),ue(e,t)}}function Ag(c,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(c.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ce(e,t))return;c.uniform3iv(this.addr,t),ue(e,t)}}function Lg(c,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(c.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ce(e,t))return;c.uniform4iv(this.addr,t),ue(e,t)}}function Dg(c,t){const e=this.cache;e[0]!==t&&(c.uniform1ui(this.addr,t),e[0]=t)}function Rg(c,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(c.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ce(e,t))return;c.uniform2uiv(this.addr,t),ue(e,t)}}function Ig(c,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(c.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ce(e,t))return;c.uniform3uiv(this.addr,t),ue(e,t)}}function Ng(c,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(c.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ce(e,t))return;c.uniform4uiv(this.addr,t),ue(e,t)}}function kg(c,t,e){const i=this.cache,o=e.allocateTextureUnit();i[0]!==o&&(c.uniform1i(this.addr,o),i[0]=o),e.setTexture2D(t||rc,o)}function Fg(c,t,e){const i=this.cache,o=e.allocateTextureUnit();i[0]!==o&&(c.uniform1i(this.addr,o),i[0]=o),e.setTexture3D(t||oc,o)}function Vg(c,t,e){const i=this.cache,o=e.allocateTextureUnit();i[0]!==o&&(c.uniform1i(this.addr,o),i[0]=o),e.setTextureCube(t||ac,o)}function Ug(c,t,e){const i=this.cache,o=e.allocateTextureUnit();i[0]!==o&&(c.uniform1i(this.addr,o),i[0]=o),e.setTexture2DArray(t||sc,o)}function Og(c){switch(c){case 5126:return bg;case 35664:return wg;case 35665:return yg;case 35666:return Mg;case 35674:return Sg;case 35675:return Cg;case 35676:return Eg;case 5124:case 35670:return Tg;case 35667:case 35671:return Pg;case 35668:case 35672:return Ag;case 35669:case 35673:return Lg;case 5125:return Dg;case 36294:return Rg;case 36295:return Ig;case 36296:return Ng;case 35678:case 36198:case 36298:case 36306:case 35682:return kg;case 35679:case 36299:case 36307:return Fg;case 35680:case 36300:case 36308:case 36293:return Vg;case 36289:case 36303:case 36311:case 36292:return Ug}}function zg(c,t){c.uniform1fv(this.addr,t)}function Bg(c,t){const e=Ri(t,this.size,2);c.uniform2fv(this.addr,e)}function Gg(c,t){const e=Ri(t,this.size,3);c.uniform3fv(this.addr,e)}function Hg(c,t){const e=Ri(t,this.size,4);c.uniform4fv(this.addr,e)}function Wg(c,t){const e=Ri(t,this.size,4);c.uniformMatrix2fv(this.addr,!1,e)}function qg(c,t){const e=Ri(t,this.size,9);c.uniformMatrix3fv(this.addr,!1,e)}function jg(c,t){const e=Ri(t,this.size,16);c.uniformMatrix4fv(this.addr,!1,e)}function Xg(c,t){c.uniform1iv(this.addr,t)}function $g(c,t){c.uniform2iv(this.addr,t)}function Kg(c,t){c.uniform3iv(this.addr,t)}function Yg(c,t){c.uniform4iv(this.addr,t)}function Zg(c,t){c.uniform1uiv(this.addr,t)}function Jg(c,t){c.uniform2uiv(this.addr,t)}function Qg(c,t){c.uniform3uiv(this.addr,t)}function t_(c,t){c.uniform4uiv(this.addr,t)}function e_(c,t,e){const i=this.cache,o=t.length,a=Zr(e,o);ce(i,a)||(c.uniform1iv(this.addr,a),ue(i,a));for(let h=0;h!==o;++h)e.setTexture2D(t[h]||rc,a[h])}function n_(c,t,e){const i=this.cache,o=t.length,a=Zr(e,o);ce(i,a)||(c.uniform1iv(this.addr,a),ue(i,a));for(let h=0;h!==o;++h)e.setTexture3D(t[h]||oc,a[h])}function i_(c,t,e){const i=this.cache,o=t.length,a=Zr(e,o);ce(i,a)||(c.uniform1iv(this.addr,a),ue(i,a));for(let h=0;h!==o;++h)e.setTextureCube(t[h]||ac,a[h])}function r_(c,t,e){const i=this.cache,o=t.length,a=Zr(e,o);ce(i,a)||(c.uniform1iv(this.addr,a),ue(i,a));for(let h=0;h!==o;++h)e.setTexture2DArray(t[h]||sc,a[h])}function s_(c){switch(c){case 5126:return zg;case 35664:return Bg;case 35665:return Gg;case 35666:return Hg;case 35674:return Wg;case 35675:return qg;case 35676:return jg;case 5124:case 35670:return Xg;case 35667:case 35671:return $g;case 35668:case 35672:return Kg;case 35669:case 35673:return Yg;case 5125:return Zg;case 36294:return Jg;case 36295:return Qg;case 36296:return t_;case 35678:case 36198:case 36298:case 36306:case 35682:return e_;case 35679:case 36299:case 36307:return n_;case 35680:case 36300:case 36308:case 36293:return i_;case 36289:case 36303:case 36311:case 36292:return r_}}class o_{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.setValue=Og(e.type)}}class a_{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.size=e.size,this.setValue=s_(e.type)}}class l_{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){const o=this.seq;for(let a=0,h=o.length;a!==h;++a){const u=o[a];u.setValue(t,e[u.id],i)}}}const ro=/(\w+)(\])?(\[|\.)?/g;function Sl(c,t){c.seq.push(t),c.map[t.id]=t}function c_(c,t,e){const i=c.name,o=i.length;for(ro.lastIndex=0;;){const a=ro.exec(i),h=ro.lastIndex;let u=a[1];const p=a[2]==="]",d=a[3];if(p&&(u=u|0),d===void 0||d==="["&&h+2===o){Sl(e,d===void 0?new o_(u,c,t):new a_(u,c,t));break}else{let m=e.map[u];m===void 0&&(m=new l_(u),Sl(e,m)),e=m}}}class jr{constructor(t,e){this.seq=[],this.map={};const i=t.getProgramParameter(e,35718);for(let o=0;o<i;++o){const a=t.getActiveUniform(e,o),h=t.getUniformLocation(e,a.name);c_(a,h,this)}}setValue(t,e,i,o){const a=this.map[e];a!==void 0&&a.setValue(t,i,o)}setOptional(t,e,i){const o=e[i];o!==void 0&&this.setValue(t,i,o)}static upload(t,e,i,o){for(let a=0,h=e.length;a!==h;++a){const u=e[a],p=i[u.id];p.needsUpdate!==!1&&u.setValue(t,p.value,o)}}static seqWithValue(t,e){const i=[];for(let o=0,a=t.length;o!==a;++o){const h=t[o];h.id in e&&i.push(h)}return i}}function Cl(c,t,e){const i=c.createShader(t);return c.shaderSource(i,e),c.compileShader(i),i}let u_=0;function h_(c,t){const e=c.split(`
`),i=[],o=Math.max(t-6,0),a=Math.min(t+6,e.length);for(let h=o;h<a;h++){const u=h+1;i.push(`${u===t?">":" "} ${u}: ${e[h]}`)}return i.join(`
`)}function d_(c){switch(c){case $n:return["Linear","( value )"];case Jt:return["sRGB","( value )"];default:return console.warn("THREE.WebGLProgram: Unsupported encoding:",c),["Linear","( value )"]}}function El(c,t,e){const i=c.getShaderParameter(t,35713),o=c.getShaderInfoLog(t).trim();if(i&&o==="")return"";const a=/ERROR: 0:(\d+)/.exec(o);if(a){const h=parseInt(a[1]);return e.toUpperCase()+`

`+o+`

`+h_(c.getShaderSource(t),h)}else return o}function p_(c,t){const e=d_(t);return"vec4 "+c+"( vec4 value ) { return LinearTo"+e[0]+e[1]+"; }"}function f_(c,t){let e;switch(t){case Ad:e="Linear";break;case Ld:e="Reinhard";break;case Dd:e="OptimizedCineon";break;case Rd:e="ACESFilmic";break;case Id:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+c+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}function m_(c){return[c.extensionDerivatives||c.envMapCubeUVHeight||c.bumpMap||c.tangentSpaceNormalMap||c.clearcoatNormalMap||c.flatShading||c.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(c.extensionFragDepth||c.logarithmicDepthBuffer)&&c.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",c.extensionDrawBuffers&&c.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(c.extensionShaderTextureLOD||c.envMap||c.transmission)&&c.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(ir).join(`
`)}function g_(c){const t=[];for(const e in c){const i=c[e];i!==!1&&t.push("#define "+e+" "+i)}return t.join(`
`)}function __(c,t){const e={},i=c.getProgramParameter(t,35721);for(let o=0;o<i;o++){const a=c.getActiveAttrib(t,o),h=a.name;let u=1;a.type===35674&&(u=2),a.type===35675&&(u=3),a.type===35676&&(u=4),e[h]={type:a.type,location:c.getAttribLocation(t,h),locationSize:u}}return e}function ir(c){return c!==""}function Tl(c,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return c.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Pl(c,t){return c.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const v_=/^[ \t]*#include +<([\w\d./]+)>/gm;function fo(c){return c.replace(v_,x_)}function x_(c,t){const e=Ft[t];if(e===void 0)throw new Error("Can not resolve #include <"+t+">");return fo(e)}const b_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Al(c){return c.replace(b_,w_)}function w_(c,t,e,i){let o="";for(let a=parseInt(t);a<parseInt(e);a++)o+=i.replace(/\[\s*i\s*\]/g,"[ "+a+" ]").replace(/UNROLLED_LOOP_INDEX/g,a);return o}function Ll(c){let t="precision "+c.precision+` float;
