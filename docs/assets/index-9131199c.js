...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function yl(){return new Jn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:So(),fragmentShader:`
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function Ml(){return new Jn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:So(),fragmentShader:`
...
#define LOW_PRECISION`),t}function L_(c){let t="SHADOWMAP_TYPE_BASIC";return c.shadowMapType===zl?t="SHADOWMAP_TYPE_PCF":c.shadowMapType===md?t="SHADOWMAP_TYPE_PCF_SOFT":c.shadowMapType===ir&&(t="SHADOWMAP_TYPE_VSM"),t}function D_(c){let t="ENVMAP_TYPE_CUBE";if(c.envMap)switch(c.envMapMode){case Ti:case Pi:t="ENVMAP_TYPE_CUBE";break;case Qr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function R_(c){let t="ENVMAP_MODE_REFLECTION";if(c.envMap)switch(c.envMapMode){case Pi:t="ENVMAP_MODE_REFRACTION";break}return t}function I_(c){let t="ENVMAP_BLENDING_NONE";if(c.envMap)switch(c.combine){case Hl:t="ENVMAP_BLENDING_MULTIPLY";break;case kd:t="ENVMAP_BLENDING_MIX";break;case Fd:t="ENVMAP_BLENDING_ADD";break}return t}function N_(c){const t=c.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function k_(c,t,e,i){const o=c.getContext(),a=e.defines;let h=e.vertexShader,u=e.fragmentShader;const p=L_(e),d=D_(e),f=R_(e),m=I_(e),_=N_(e),b=e.isWebGL2?"":M_(e),y=S_(a),x=o.createProgram();let g,S,D=e.glslVersion?"#version "+e.glslVersion+`
